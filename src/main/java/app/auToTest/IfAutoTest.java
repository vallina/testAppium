...
public class IfAutoTest {
    ...
    public String getApkFileAbsolutePath() {
        ...
        for (File f : files) {
            System.out.println("ApkFileAbsolutePath==="+f.getAbsolutePath());
    ...
    public void setUp() throws Exception {
        System.out.println("sleep 60s wait appium server start...");
        for (int i=0; i<60; i++) {
        ...
        capabilities.setCapability("udid","WTKDU16921010173");
        ...
        if (isInstall) {
            ...
            capabilities.setCapability("app", this.getApkFileAbsolutePath());
        }
