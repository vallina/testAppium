...
public class ifTest2 {
    ...
    public void setUp() throws Exception {
        ...
        driver = new AndroidDriver(new URL("http://192.168.2.56:4723/wd/hub"), capabilities);
    ...
    public void login() throws InterruptedException {
        ...
        driver.findElementById("com.douyaim.qsapp.ifme:id/edit_view").sendKeys("13900000009");
        driver.findElementById("com.douyaim.qsapp.ifme:id/tvGetCheckCode").click();
        driver.findElementById("com.douyaim.qsapp.ifme:id/edit_view_check_code").sendKeys("0629");
        Thread.sleep(3000);
